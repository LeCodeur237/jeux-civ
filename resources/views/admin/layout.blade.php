...
<head>
    ...
    <style>
        ...
        .sidebar { min-height: 100vh; width: 250px; background-color: #343a40; color: white; flex-shrink: 0; }
        .sidebar a { color: rgba(255,255,255,.8); text-decoration: none; padding: 10px 15px; display: block; }
        .sidebar a:hover, .sidebar a.active { background-color: #7d1900; color: white; }
...
<body>
    <div class="d-flex flex-column flex-md-row min-vh-100">
        <div class="sidebar d-flex flex-column p-3">
            ...
            <a href="{{ url('/home') }}" class="mt-auto border-top pt-3">
